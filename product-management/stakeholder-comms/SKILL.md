...
description: >
  Status updates, escalation emails, and exec summaries. Use this skill whenever the user asks for help with
  anything related to stakeholder comms. Trigger even on casual phrasing — if the
